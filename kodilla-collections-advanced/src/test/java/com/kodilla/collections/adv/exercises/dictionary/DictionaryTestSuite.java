...
public class DictionaryTestSuite {
    ...
    public void testAddWord() {
        // given
        // w tej sekcji przygotowujemy dane testowe,
        // obiekt do testowania oraz wszystkie inne rzeczy,
        // które muszą zostać przygotowane,
        // zanim nastąpi wywołanie testowanej metody
        Dictionary dictionary = new Dictionary();
        String polishWord = "stos";
        EnglishWord englishWord = new EnglishWord(PartOfSpeech.NOUN,"stack");
        // when
        // w tej sekcji z reguły znajduje się tylko jedna linia –
        // jest to wywołanie metody, którą testuje nasz test
        dictionary.addWord(polishWord,englishWord);
        // then
        // sekcja poświęcona sprawdzeniu, czy testowana klasa
        // zachowała się poprawnie – tutaj zamieszczamy wszystkie asercje
